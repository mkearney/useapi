...
#' Convert useapitest output to tibble
#'
#' Convert useapitest response objects into informative tibbles
#'
#' @param x Output from useapitest function
#' @return Print out of summary info and a tibble of the data.
#' @export
useapitest_as_tbl <- function(x) {
